            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control text-bg-dark" id="username" name="username" placeholder="username" required>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label for="origin" class="form-label">Correo electronico (example@example.cl)</label>
                        <input type="email"  class="form-control text-bg-dark" name="email" id="email" placeholder="example@example.cl" required>
                    </div>
