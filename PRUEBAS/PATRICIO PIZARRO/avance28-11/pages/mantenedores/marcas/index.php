...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                    ...
                    <h2 class="fs-2 mx-4 text-white">Mantenedor Marcas</h2>
                    ...
                    <?php while ($fila = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index.php?p=mantenedores/marcas/edit&id=<?= $fila['id'] ?>" class="btn btn-sm text-white btn-outline-warning">Editar</a>
                                
                                <a href="javascript:borrar(<?= $fila['id'] ?>);" class="btn btn-sm text-white btn-outline-danger">Eliminar</a>
                            </td>
                        </tr>
