...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
        ...
        <div class="card text-bg-dark">
            ...
            <div class="card-body table-responsive text-bg-dark"  id="bbbb">
                <table border = 1 cellpadding = 10 class="table table-hover table-dark table-striped tableAux dataTables table-borderless" id="" >
                    <thead class="">
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col"></th>
                    ...
                    <tbody>
                        <?php while ($fila = mysqli_fetch_array($result)) : ?>
                            <tr>
                                ...
                                <button class="btn float-end text-white border-white btn-marcar-equipo" data-id="<?= $fila['id'] ?>">Marcar</button>
                    ...
                    <tbody>
                        <?php while ($fila = mysqli_fetch_array($result2)) : ?>
                            <tr>
                                ...
                                <button class="btn float-end text-white border-white btn-marcar-funcionario" data-id="<?= $fila['id'] ?>">Marcar</button>
