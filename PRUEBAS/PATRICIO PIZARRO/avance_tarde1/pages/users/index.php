    ...
    <div class="card text-bg-dark">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a class="btn btn-sm text-white btn-outline-success border border-light" href="index.php?p=users/create" role="button">Agregar nuevo</a>
                </div>
            </div>
        </div>
                    ...
                    <?php while ($user = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <a href="index.php?p=users/edit&id=<?= $user['id'] ?>" class="btn btn-sm text-white btn-outline-warning border border-light">Editar</a>
                                <a href="javascript:borrar(<?= $user['id'] ?>);" class="btn btn-sm text-white btn-outline-danger border border-light">Eliminar</a>
                                </div>
                            </td>
                        </tr>
