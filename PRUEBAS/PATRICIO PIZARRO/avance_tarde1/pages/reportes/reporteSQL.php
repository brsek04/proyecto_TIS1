                ...
                <div class="card-body table-responsive text-bg-dark">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control text-bg-dark" id="fechaInicio" name="fechaInicio">
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="fechaTermino" class="form-label">Fecha Termino</label>
                            <input type="date" class="form-control text-bg-dark" id="fechaTermino" name="fechaTermino">
                        </div>

                        <div class="col-md-12 mb-3">
                            <label class="form-check-label">Funcionario</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="funcionarioCheckbox"
                                    name="funcionarioCheckbox">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formaIngresoCheckbox"
                                    name="formaIngresoCheckbox">
                            </div>
                        </div>
