...
<head>
  ...
  <!-- COUNTER STRIKES -->
  <link rel="stylesheet"
    href="http://localhost/xampp/proyecto_TIS1/PRUEBAS/PATRICIO%20PIZARRO/avance_tarde1/includes/estilos.css">
                ...
                <div class="collapse " id="equipo-collapse" style="">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ">
                    ...
                    <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                        ...
                        asignados</a></li>
                    <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                        href="index.php?p=equipos/equiposPanel"> <i class="bi bi-arrow-return-right me-1"></i>Panel de
                        Equipos</a></li>
                  </ul>
                </div>
              </li>
              ...
              <ul class="list-unstyled ps-0">
                ...
                <ul class="list-unstyled ps-0">
                  ...
                  <a href="index.php?p=equipos/indexTickets"
                    ...
                    <li class="border-top border-0 "></li>
