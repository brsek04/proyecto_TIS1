...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                    ...
                    <h2 class="fs-2 mx-4 text-white">Almacenamientos</h2>
...
<?php if ($deletionSuccess): ?>
                ...
                <div>              
                    <a class="btn btn-sm text-white btn-outline-success border border-light" href="index.php?p=mantenedores/almacenamientos/create" role="button">Agregar nuevo</a>
                </div>
            </div>
        </div>
        <div class="card-body table-responsive text-bg-dark">
            <table class="table table-hover table-dark table-striped tableAux dataTables table-borderless">
                <thead class="">
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Almacenamientos</th>
                ...
                <tbody>
                    <?php while ($fila = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <td><?= $fila['almacenamiento'] ?> GB</td>
                          
                            <td>


                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group"> 
                                <a href="index.php?p=mantenedores/almacenamientos/edit&id=<?= $fila['id'] ?>" class="btn btn-sm text-white btn-outline-warning border border-light">Editar</a>
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Si, borrar',
                ...
                if (result.isConfirmed) {
                    window.location="pages/mantenedores/almacenamientos/actions/delete.php?id="+id;
