<?php
    ...
    $query = "SELECT * FROM tipoAlmacenamientos";
    $result = mysqli_query($connection, $query);
?>

<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                
                    <h2 class="fs-2 mx-4 text-white">Tipos de almacenamientos</h2>
    ...
    <div class="card text-bg-dark">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>              
                    <a class="btn btn-sm text-white btn-outline-success border border-light" href="index.php?p=mantenedores/tipoAlmacenamientos/create" role="button">Agregar nuevo</a>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    <?php while ($fila = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <td><?= $fila['tipoAlmacenamiento'] ?></td>
                          
                            <td>


                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group"> 
                                <a href="index.php?p=mantenedores/tipoAlmacenamientos/edit&id=<?= $fila['id'] ?>" class="btn btn-sm text-white btn-outline-warning border border-light">Editar</a>
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Si, borrar',
                ...
                if (result.isConfirmed) {
                    window.location="pages/mantenedores/tipoAlmacenamientos/actions/delete.php?id="+id;
