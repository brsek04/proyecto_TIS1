        ...
        <div class="card text-bg-dark">
            ...
            <div class="card-body table-responsive text-bg-dark" id="bbbb">
                <table cellpadding=10
                    class="table table-hover table-dark table-striped tableAux dataTables table-borderless" id="">
                    <thead class="">
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        <?php while ($fila = mysqli_fetch_array($result)): ?>
                            <tr>
                                ...
                                <td>
                                    <?= $fila['marcas'] . ',' . $fila['modelo'] . ', ' . $fila['nombreOpcion'] . ', ' . $fila['memorias'] . ', ' . $fila['almacenamientos'] ?>
    ...
    <div class="row" id="contenedortabla">
        <div class="card text-bg-dark">
            ...
            <div class="card-body table-responsive  text-bg-dark">
                ...
                <button class="btn btn-sm text-white btn-outline-primary border border-light" id="btnAsignar">Asignar</button>
            </div>
            <br>
        </div>
