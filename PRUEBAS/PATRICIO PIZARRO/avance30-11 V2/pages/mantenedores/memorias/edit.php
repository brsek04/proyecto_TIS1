...
$query = "SELECT * FROM memorias WHERE id=" . $id . ";";
...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <h2 class="fs-2 mx-4 text-white">Editar memoria de equipo <?php echo $id ?></h2>
...
<div class="row" id="contenedortabla"> 
    <div class="card text-bg-dark">
        <form action="pages/mantenedores/memoria/actions/update.php" method="POST">
            <div class="card-body table-responsive text-bg-dark ">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control text-bg-dark" id="opcion" name="opcion" value="<?php echo $opcion ?>">
                    </div>
                </div>
            </div>
