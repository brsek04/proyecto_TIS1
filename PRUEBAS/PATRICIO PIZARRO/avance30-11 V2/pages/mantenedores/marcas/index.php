...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                    ...
                    <h2 class="fs-2 mx-4 text-white">Marcas</h2>
    ...
    <div class="card text-bg-dark" >
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>              
                    <a class="btn btn-sm text-white btn-outline-success border border-light" href="index.php?p=mantenedores/marcas/create" role="button">Agregar nuevo</a>
                </div>
            </div>
        </div>
                    ...
                    <?php while ($fila = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <a href="index.php?p=mantenedores/marcas/edit&id=<?= $fila['id'] ?>" class="btn btn-sm text-white btn-outline-warning border border-light">Editar</a>
