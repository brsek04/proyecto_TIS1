...
$(document).ready(function() {
    $(".scrollDataTables").DataTable({
        "scrollY": "300px", // Altura máxima para la barra de desplazamiento vertical
            // Habilita la barra de desplazamiento horizontal si es necesario
      
        "paging": false      // Deshabilita la paginación si no es necesaria
    });
});
</script>
