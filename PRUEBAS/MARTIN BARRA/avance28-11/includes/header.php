...
<head>
  ...
  <!-- COUNTER STRIKES -->
  <link rel="stylesheet"
    href="http://localhost/xampp/proyecto_TIS1/PRUEBAS/PATRICIO%20PIZARRO/avance28-11/includes/estilos.css">
    ...
    <div class="" id="sidebar-wrapper">
      <li class="nav-item row align-items-start">
        <a class="nav-link <?php echo ($pagina == 'home') ? 'active' : null ?>" aria-current="page"
          href="index.php?p=home"><img class="p-0 m-3" src="logo-inventrack.png" alt="" width="240"></a>
      </li>
            ...
            <div class="collapse " id="equipo-collapse" style="">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ">
                <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                    href="index.php?p=equipos/index"> <i class="bi bi-arrow-return-right me-1"></i>Todos los equipos</a></li>
                <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold "
                    href="index.php?p=equipos/equiposDisponibles"> <i class="bi bi-arrow-return-right me-1"></i>Equipos disponibles</a></li>
                <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                    href="index.php?p=equipos/equiposAsignados"> <i class="bi bi-arrow-return-right me-1"></i>Equipos asignados</a></li>
              </ul>
            </div>
          </li>
          ...
          <ul class="list-unstyled ps-0">
            <li class="mb-1">
              ...
              <div class="collapse" id="funcionario-collapse" style="">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                  <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                      href="index.php?p=mantenedores/funcionarios/index"><i class="bi bi-arrow-return-right me-1"></i>Todos los funcionarios</a></li>
                  <li><a class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                      href="index.php?p=mantenedores/funcionarios/funcionariosAsignados"><i class="bi bi-arrow-return-right me-1"></i>Funcionarios asignados</a></li>
                </ul>
              </div>
            </li>
            ...
            <ul class="list-unstyled ps-0">
                ...
                <div class="collapse" id="asignacion-collapse" style="">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a
                        ...
                        href="index.php?p=equipos/asignacion/index"><i class="bi bi-arrow-return-right me-1"></i>Asignar</a></li>
                    <li><a
                        class="dropdown-item list-group-item list-group-item-action bg-transparent second-text fw-bold"
                        href="index.php?p=mantenedores/funcionarios/EditarAsignacion"><i class="bi bi-arrow-return-right me-1"></i>Editar</a></li>
                  </ul>
                </div>
              </li>
              ...
              <a href="index.php?p=calendario/index" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
              ...
              <a class=" list-group-item list-group-item-action bg-transparent nav-link second-text fw-bold"  href="index.php?p=auth/profile" id="navbarDropdown"
