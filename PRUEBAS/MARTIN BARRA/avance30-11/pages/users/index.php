                    ...
                    <?php while ($user = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <a href="index.php?p=users/edit&id=<?= $user['id'] ?>" class="btn btn-sm btn-outline-light">Editar</a>
                                <a href="javascript:borrar(<?= $user['id'] ?>);" class="btn btn-sm btn-outline-light">Eliminar</a>
                                </div>
                            </td>
                        </tr>
