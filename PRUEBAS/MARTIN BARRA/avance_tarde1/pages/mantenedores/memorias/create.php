...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <h2 class="fs-2 mx-4 text-white">Agregar nueva memoria de equipo</h2>
        ...
        <form action="pages/mantenedores/memorias/actions/store.php" method="POST">
            <div class="card-body table-responsive text-bg-dark">
                ...
                <div class="col-md-12 mb-3">
                        <label for="opcion" class="form-label">Capacidad de memoria</label>
                        <input type="text" class="form-control text-bg-dark" id="opcion" name="opcion" placeholder="2, 4, 8, 16 en gigabytes">
                    </div>
