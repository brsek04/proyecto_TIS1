                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a class="btn btn-sm text-white btn-outline-success border border-light"
                            href="index.php?p=mantenedores/tipoAlmacenamientos/create" role="button">Agregar nuevo</a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php while ($fila = mysqli_fetch_array($result)): ?>
                            <tr>
                                ...
                                <td>
                                    <?= $fila['tipoAlmacenamiento'] ?>
                                </td>
                                <td>
                                    <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                        <a href="index.php?p=mantenedores/tipoAlmacenamientos/edit&id=<?= $fila['id'] ?>"
