...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css"
        integrity="sha384-rbs5jfMz1DA5/yo2Dm/YBrZfuZ9foKTfvcDxpP1wq" crossorigin="anonymous">
...
<body>
                        ...
                        <tbody>
                            <?php while ($fila = mysqli_fetch_array($result)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?p=equipos/ticketsAction/update&id=<?= $fila['id'] ?>"
                                            class="btn btn-sm text-white btn-outline-warning border border-light">Rechazar</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.10.2/dist/umd/popper.min.js"
        integrity="sha384-mQ93GR66B00ZXjt0YO5KlohRA5SY2XofP+WiNDi7fxj3m2aqA6bXykO+5l5E0e5Q"
        crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"
        integrity="sha384-EU3m5zQ02eAxZAeKM9XlFR7KaLsD7jsyPPFRfFsw5eVCgMBeRcXMIch5cjo5gZbY"
        crossorigin="anonymous"></script>
