                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-control text-bg-dark" id="tipoAlmacenamientos"
                                name="tipoAlmacenamientos">
                                <option disabled>Selecciona una opción</option>
                                <?php
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control text-bg-dark" id="fechaMantencion"
                                name="fechaMantencion" value="<?php echo $fechaMantencion ?>">
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control text-bg-dark" id="costo" name="costo"
