...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                    ...
                    <h2 class="fs-2 mx-4 text-white">Panel de equipos</h2>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a class="btn btn-sm text-white btn-outline-success border border-light" href="index.php?p=equipos/create" role="button">Agregar nuevo</a>
                </div>
            </div>
        </div>

        <div class="card-body table-responsive text-bg-dark"  id="bbbb">
            <table style="border: 1; cellpadding: 10;" class="table table-hover table-dark table-striped tableAux dataTables table-borderless" id="tablaEquipos" >
                <thead class="">
                    <tr>
                        <th scope="col">#</th>
                    ...
                    <?php while ($fila = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <a href="index.php?p=equipos/edit&id=<?= $fila['id'] ?>" class="btn btn-sm text-white btn-outline-warning border border-light">Editar</a>
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                             <div class="modal-content">
                                                    ...
                                                    <h1 class=" modal-title fs-5 text-center" style="color:black;" id="exampleModalLabel">Qr para dispositivo</h1>
...
<script>
    ...
    const link = "http://localhost/xampp/proyecto_TIS1/PRUEBAS/PATRICIO%20PIZARRO/avance29-11/index.php?p=equipos/busquedaQR&id="
